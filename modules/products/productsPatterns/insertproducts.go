...
func NewInsertProductBuilder(db *sqlx.DB, req *products.Products) IInsertProductBuilder {
...
func NewInsertProductEngineer(builder IInsertProductBuilder) *insertProductEngineer {
