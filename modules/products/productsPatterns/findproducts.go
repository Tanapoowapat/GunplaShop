...
func NewFindProductBuilder(db *sqlx.DB, req *products.ProductFilter) IFindProductBuilder {
...
func (b *findProductBuilder) Count() int {
	...
	if err := b.db.Get(&count, b.query, b.values...); err != nil {
		log.Printf("count producuts fail: %v\n", err)
		return 0
	}
	b.resetQuery()
	return count
...
func NewFindProductEngineer(builder IFindProductBuilder) *findProductEngineer {
